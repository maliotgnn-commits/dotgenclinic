...
assert(publicHeaderJs.includes("drawer.setAttribute('role', 'dialog')"), 'mobile drawer must expose dialog semantics');
assert(publicHeaderJs.includes("drawer.setAttribute('aria-modal', 'true')"), 'mobile drawer must be marked modal');
assert(publicHeaderJs.includes("sibling.setAttribute('inert', '')"), 'mobile drawer must make outside content inert');
assert(publicHeaderJs.includes("event.key !== 'Tab'"), 'mobile drawer must contain keyboard focus');
