...
- [ ] P0 secrets rotated in Vercel Production + Preview
- [ ] Admin login verified
- [ ] GA4 dashboard returns data
- [ ] GSC site URL + SA access verified
- [ ] GBP vars present **or** explicitly deferred
- [ ] Doctor noindex policy still intentional
